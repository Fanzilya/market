...
const getIcon = (name: IconName, width: number, height: number, color: string): React.ReactNode => {
...
<path d="M15 12C15 13.6569 13.6569 15 12 15C10.3431 15 9 13.6569 9 12C9 10.3431 10.3431 9 12 9C13.6569 9 15 10.3431 15 12Z" stroke={color} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    phone: (
      <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M22 16.92V19.92C22.001 20.1985 21.9441 20.4742 21.8325 20.7294C21.7209 20.9845 21.5573 21.2136 21.3521 21.4019C21.1468 21.5902 20.9046 21.7335 20.6408 21.8227C20.3769 21.9119 20.0974 21.9451 19.82 21.92C16.7428 21.5856 13.787 20.5341 11.19 18.85C8.77382 17.3147 6.72533 15.2662 5.19002 12.85C3.49998 10.2412 2.44825 7.271 2.12002 4.18C2.09496 3.9035 2.12783 3.62479 2.21657 3.36157C2.30531 3.09835 2.44786 2.85659 2.63528 2.65126C2.8227 2.44592 3.0508 2.28199 3.30513 2.16964C3.55946 2.05729 3.83449 1.99927 4.11302 2.00001H7.11302C7.5953 1.99528 8.06021 2.18716 8.39376 2.52655C8.7273 2.86594 8.91956 3.32291 8.92002 3.80001C9.0287 5.19989 9.32249 6.57774 9.79002 7.90001C9.9281 8.26685 9.96207 8.66426 9.88801 9.04839C9.81395 9.43253 9.63491 9.78684 9.37202 10.07L8.10002 11.3C9.49227 13.757 11.463 15.7278 13.92 17.12L15.15 15.85C15.4332 15.5871 15.7875 15.408 16.1717 15.334C16.5558 15.2599 16.9532 15.2939 17.32 15.432C18.6424 15.8866 20.0198 16.1746 21.42 16.29C21.8982 16.296 22.3547 16.4925 22.6922 16.8289C23.0298 17.1654 23.221 17.6278 23.22 18.11L22 16.92Z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
