...
export const SchemaCore = ({ workingPumps, reservePumps, inletDiameter, outletDiameter, insulation, totalPumps, extras }) => (
...
export const Pumps = ({ workingPumps, reservePumps, totalPumps }) => (
    <>
...
export const InletPipeline = ({ inletDiameter, extras }) => (
    <g>
        <line
            x1="-200"
            y1="50"
...
export const OutletPipeline = ({ outletDiameter, extras }) => (
    <g>
        <line
            x1="100"
            y1="50"
...
export const SchemaLegend = ({ extras }) => {
...
export const SchemaDimensions = ({ inletDiameter, outletDiameter, stationDiameter, stationHeight }) => (
