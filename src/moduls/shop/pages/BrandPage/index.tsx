...
import { getProductsByBrand } from "@/shared/data/products";
      ...
      <div className={styles.brandHeader}>
        ...
        <div className={styles.brandInfo}>
          ...
          <div className={styles.brandMeta}>
            <span className={styles.brandCountry}>{brand.city}</span>
            <span className={styles.metaDivider}>•</span>
            <span className={styles.brandFounded}>
              Основан в {brand.founded}
            </span>
            <span className={styles.metaDivider}>•</span>
            <span className={styles.brandProducts}>
              {brand.products} товаров
            </span>
          </div>
