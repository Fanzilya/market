...
import { cabinetLocationOptions, directionOptions, mediumOptions } from '../technical-pump-parameters-step/src/data';
...
export const TechnicalPumpParametersStep = observer(({ knsData, styles, formData, setKnsData, elements, setElementChecked }: Props) => {
    return (
