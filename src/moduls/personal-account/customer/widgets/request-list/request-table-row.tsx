...
export const RequestTableRow = ({ styles, item, openArchiveConfirm, goToEditRequest, handleDeleteRequest, handleResubmit, number, gridClass, onArhiv, onChangeStatus }: Props) => {
                    ...
                    {user?.role == Role.Admin &&
                        <div className="flex gap-3 justify-center items-center">
                            ...
                            {/* <div className="">
                                ...
                                />
                                <button className='' onClick={(e) => { e.stopPropagation(); onChangeStatus!() }}>
