...
import { useFavoritesRequestListModel } from '../../features/favorites-request-list-model/useFavoritesRequestListModel'


export const FavoritesRequestListPage = () => {
  const { user } = useAuth()
  ...
  const { requests, isLoading, onFavoriteRemove, isError, errors } = useFavoritesRequestListModel()
